...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        audit_samples = [
            {'attempt_type': 'LOGIN', 'challenge_phrase': 'My voice is my secure key for voice biometric', 'spoken_transcript': 'My voice is my secure key for voice biometric', 'similarity_score': 0.89, 'threshold_used': 0.72, 'confidence_score': 97.8, 'liveness_score': 0.92, 'snr_db': 24.5, 'decision': 'ACCEPTED', 'latency_ms': 17.8, 'client_ip': '192.168.1.104'},
            {'attempt_type': 'STEP_UP_TRANSACTION', 'challenge_phrase': 'Voice Biometric authentication token 8492 verified', 'spoken_transcript': 'Voice Biometric authentication token 8492 verified', 'similarity_score': 0.91, 'threshold_used': 0.80, 'confidence_score': 98.9, 'liveness_score': 0.94, 'snr_db': 26.1, 'decision': 'ACCEPTED', 'latency_ms': 18.2, 'client_ip': '192.168.1.104'},
            {'attempt_type': 'LOGIN', 'challenge_phrase': 'Voice Biometric verification code 3912', 'spoken_transcript': 'Voice Biometric verification code 3912', 'similarity_score': 0.78, 'threshold_used': 0.72, 'confidence_score': 74.2, 'liveness_score': 0.41, 'snr_db': 14.2, 'decision': 'SPOOF_DETECTED', 'attack_type': 'REPLAY_ATTACK', 'rejection_reason': 'Security Violation: Low Bandwidth Replay Suspect (Smartphone loudspeaker detected)', 'latency_ms': 19.4, 'client_ip': '45.134.22.89'},
            {'attempt_type': 'LOGIN', 'challenge_phrase': 'Confirm secure identity clearance for voice biometric', 'spoken_transcript': '', 'similarity_score': 0.44, 'threshold_used': 0.72, 'confidence_score': 1.8, 'liveness_score': 0.86, 'snr_db': 22.0, 'decision': 'REJECTED', 'rejection_reason': 'Voiceprint mismatch (Similarity 0.440 < Threshold 0.720)', 'latency_ms': 16.5, 'client_ip': '192.168.1.104'},
